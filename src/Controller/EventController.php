...
class EventController extends AbstractController
{
    ...
    #[Route('/all_back', name: 'app_event_all_index', methods: ['GET'])]
    public function index_back(EventRepository $eventRepository): Response
    {
        return $this->render('event/back_index.html.twig', [
            'events' => $eventRepository->findAll(),
        ]);
    }
